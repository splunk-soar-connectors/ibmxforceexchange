...
def test_valid_file_hash():
    ...
    summary = {
        "risk": (file_report_results["xforce_malware_report"].get("malware", {"risk": "Unknown"}).get("risk", "Unknown")),
        ...
        "family": ",".join(
            [
                family
                for family in (
                    file_report_results["xforce_malware_report"].get("malware", {"origins": None}).get("origins", {"family": None}).get(
                        "family", []
                    )
                )
            ]
    ...
    file_report_results = _cleanup_dict(file_report_results, ["xforce_malware_report", "malware", "family"], None, "name")

    file_report_results = _cleanup_dict(file_report_results, ["xforce_malware_report", "malware", "origins", "external", "family"], None, "name")
...
def test_invalid_file_hash():
    ...
    summary = {
        "risk": (file_report_results["xforce_malware_report"].get("malware", {"risk": "Unknown"}).get("risk", "Uknown")),
        "cnc_servers": cnc_server_count,
        "email_sources": email_source_count,
        "email_subjects": email_subject_count,
        "download_sources": download_source_count,
